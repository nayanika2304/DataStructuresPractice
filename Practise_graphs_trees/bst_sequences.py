'''
Backtracking is essential for solving constraint satisfaction problems,
such as crosswords, verbal arithmetic, Sudoku, and many other puzzles.
It is also used in solving the knapsack problem,
parsing texts and other combinatorial optimization problems.

https://stackoverflow.com/questions/22761387/given-a-binary-search-tree-print-all-combination-of-inputs-that-forms-the-same
'''
